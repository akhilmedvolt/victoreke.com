...
export const metadata: Metadata = {
  title: "Blog | Akhil Sanker",
  metadataBase: new URL("https://akhilsanker.com/blog"),
  description: "Read latest stories from Akhil Sanker's Blog",
  openGraph: {
    title: "Blog | Akhil Sanker",
    url: "https://akhilsanker.com/blog",
    description: "Read latest stories from Akhil Sanker's Blog",
    images:
      "https://res.cloudinary.com/akhilsanker/image/upload/v1692636087/akhilsanker/blog.png",
  },
};
